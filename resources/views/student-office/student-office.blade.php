...
@section('title', "Student Financial Aid Office — Government Postgraduate College Mansehra")
...
<div class="breadcrumb-bar">
    <div class="inner">
        ...
        <span class="sep">›</span>
        <span class="current">Student Financial Aid Office</span>
    </div>
</div>
    ...
    <div class="admin-container">
        ...
        <div class="admin-main">
            <div class="admin-main-header">
                <h1>Student Financial Aid Office</h1>
            </div>

            <!-- ── 1. Incharge / Head ── -->
            <div class="staff-row">
                <div class="staff-info">
                    <div class="name">Mr. [Incharge Name]</div>
                    <div class="designation">Incharge Financial Aid Office</div>
                    <div class="contact-line">
                        <i class="fas fa-envelope"></i>
                        Email: <a href="mailto:financialaid@gpgcmansehra.edu.pk">financialaid@gpgcmansehra.edu.pk</a>
                    </div>
                    <div class="contact-line">
                ...
                <div class="staff-photo">
                    {{-- <img src="{{ asset('images/staff/financialaid-head.jpg') }}" alt="Incharge"> --}}
                    <div class="no-photo">
            ...
            <div class="staff-row">
                <div class="staff-info">
                    <div class="name">Mr. [Office Assistant Name]</div>
                    <div class="designation">Office Assistant</div>
                    <div class="contact-line">
                        <i class="fas fa-envelope"></i>
                        Email: <a href="mailto:financialaid@gpgcmansehra.edu.pk">financialaid@gpgcmansehra.edu.pk</a>
                    </div>
                ...
                <div class="staff-photo">
                    {{-- <img src="{{ asset('images/staff/financialaid-asst.jpg') }}" alt="Office Assistant"> --}}
                    <div class="no-photo">
                        <svg viewBox="0 0 100 120" fill="#90a4b7" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="50" cy="32" r="22"/>
                            <path d="M10 110 Q10 72 50 72 Q90 72 90 110Z"/>
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="#" class="active">Student Financial Aid Office</a>
