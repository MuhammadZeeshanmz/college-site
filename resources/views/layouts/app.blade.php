...
<head>
    ...
    ══════════════════════════════════════════ */
        ...
        /* quick-links 2-col grid — matching screenshot icon+label style */
        .quick-grid {
            flex-shrink: 0;
            display: grid;
    ...
    ══════════════════════════════════════════ */
        ...
        .dept-card:hover .dept-card-body span {
            background: var(--green-dark);
        }
    ...
    ══════════════════════════════════════════ */
        ...
        .uoh-footer .footer-grid {
            display: grid;
            grid-template-columns: repeat(4, 1fr);
            gap: 30px;
        }

        .uoh-footer .footer-col h3 {
            font-size: 20px;
            margin-bottom: 15px;
            font-weight: 600;
        }

        .uoh-footer .footer-col ul {
            list-style: none;
            padding: 0;
        }

        .uoh-footer .footer-col ul li {
            margin-bottom: 8px;
        }

        .uoh-footer .footer-col ul li a {
            color: #ddd;
            text-decoration: none;
            font-size: 14px;
        }

        .uoh-footer .footer-col ul li a:hover {
            color: #fff;
        }

        .uoh-footer .footer-col p {
            font-size: 14px;
            line-height: 1.6;
            color: #ddd;
        }
    ...
    <div class="uoh-topbar">
        <div class="wrap">
            <div class="topbar-links">
                ...
                <a href="{{ route('alumni') }}" target="_blank">Alumni Portal</a>
        ...
        <div class="wrap">
            <a class="logo-block" href="{{ url('/') }}">
                <div class="logo-emblem">
                    ...
                    <span class="logo-emblem-text">GCM</span>
                </div>
            ...
            <div class="quick-grid">
                <a href="{{ route('downloads') }}"><span class="qi"><i class="fas fa-download"></i></span>Downloads</a>
                <a href="{{ route('tenders') }}"><span class="qi"><i class="fas fa-file-alt"></i></span>Tenders</a>
                {{-- <a href="{{ route('results') }}"><span class="qi"><i class="fas fa-chart-bar"></i></span>Online
                    Results</a> --}}
                <a href="{{ route('library') }}"><span class="qi"><i class="fas fa-book"></i></span>Central Library</a>
                <a href="{{ route('jobs-career') }}" target="_blank" rel="noopener noreferrer">
                    <span class="qi"><i class="fas fa-briefcase"></i></span>
                    Jobs &amp; Careers
                </a>
                {{-- <a href="#"><span class="qi"><i class="fas fa-scroll"></i></span>Semester Rules</a> --}}
                <a href="{{ route('semester-rules') }}"><span class="qi"><i class="fas fa-scroll"></i></span>Semester
                    Rules</a>
                {{-- <a href="{{ route('student-portal') }}"><span class="qi"><i
                            class="fas fa-desktop"></i></span>Student Portals</a> --}}
                <a href="#"><span class="qi"><i class="fas fa-university"></i></span>College Statutes</a>
            </div>
        </div>
    </div>
            ...
            <ul class="nav-list" id="main-nav">
                ...
                <li>
                    ...
                    <div class="nav-dropdown">
                        <a href="{{ route('principal') }}">Principal's Office</a>
                        <a href="{{ route('student-office') }}">Student Financial Aids Office</a>
                        <a href="{{ route('registration-office') }}">Registrar Office</a>
                        <a href="{{ route('quality-cell') }}">Quality Enhancement Cell (QEC)</a>
                ...
                <!-- JOURNALS -->
                <li>
                    <a href="{{ route('journals.index') }}">Journals <span class="caret">▾</span></a>
                    <div class="nav-dropdown">
                        <a href="{{ route('journal.detail', 'social-sciences') }}">Journal of Social Sciences</a>
                        <a href="{{ route('journal.detail', 'computer-science') }}">Journal of Computer Science</a>
                        <a href="{{ route('journal.detail', 'environmental-studies') }}">Journal of Environmental
                            Studies</a>
                    </div>
                </li>
...
══════════════════════════════════════ -->
    ...
    <footer class="uoh-footer">
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    <h3>Address</h3>
                    <p>
                        Government Postgraduate College Mansehra<br>
                        Mansehra, Khyber Pakhtunkhwa, Pakistan
                    </p>
                    <p><strong>Principal Office</strong><br>
                        Phone: +92-997-000000<br>
                        Email: principal@gpcmansehra.edu.pk</p>
                    <p><strong>Examination Section</strong><br>
                        Phone: +92-997-000001</p>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-map">
                        <iframe
                            src="https://maps.google.com/maps?q=Government+Postgraduate+College+Mansehra&t=&z=13&ie=UTF8&iwloc=&output=embed"
        ...
        <div class="footer-bottom">
            Copyright &copy; 2024-25. All Rights Reserved :: Government Postgraduate College Mansehra
        </div>
    </footer>
