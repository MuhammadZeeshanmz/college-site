...
@section('page-subtitle', 'Update announcement')
@section('content')
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header"><h6><i class="bi bi-pencil me-2 text-warning"></i>Edit Announcement</h6></div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.announcements.update', $announcement->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if($announcement->pdf)
                            <div class="mb-2">
                                <a href="{{ asset('storage/'.$announcement->pdf) }}" target="_blank"
