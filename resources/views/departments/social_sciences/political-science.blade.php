@extends('layouts.app')
@section('title', 'Department of Political Science — Government Postgraduate College Mansehra')
@section('content')
<style>
...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Political Science</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Political Science</div>
<div class="dept-grid">
...
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/political_science-dept.jpg') }}" alt="Political Science"> --}}
            <div class="intro-photo-ph">🏛️</div>
            <div class="intro-txt"><p>Welcome to the Department of Political Science at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Political Science.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/political_science-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">🏛️</div>
        <div class="gallery-caption">Political Science Dept — GPGC Mansehra</div>
    </div></div>
</div>
...
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">National Conference on Democracy and Governance 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Research Methods in Political Science <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Political Science Department Launches Policy Research Cell <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Guest Lecture on Pakistan's Foreign Policy Challenges</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Political Science Debate Competition 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Seminar on Electoral Reforms in Pakistan</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">MoU Signed with PILDAT for Research Collaboration</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">National Conference on Democracy and Governance 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Research Methods in Political Science <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Political Science Department Launches Policy Research Cell <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
...
{{-- COL 3: Programs + Announcements (scrolling) + Contact + Accreditation --}}
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Political Science</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            ...
            <li><a href="#">BS Political Science Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Research Grant Applications Open for Students <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Scholarship for Political Science Students Announced</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Summer Internship at National Assembly Secretariat</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">CSS Preparation Workshop for Final Year Students</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> polisci@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Political Science Block, GPGCM Mansehra</li>
