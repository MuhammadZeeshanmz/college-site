...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Islamic Studies</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Islamic Studies</div>
<div class="dept-grid">
...
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/islamic_studies-dept.jpg') }}" alt="Islamic Studies"> --}}
            <div class="intro-photo-ph">🕌</div>
            <div class="intro-txt"><p>Welcome to the Department of Islamic Studies at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Islamic Studies.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/islamic_studies-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">🕌</div>
        <div class="gallery-caption">Islamic Studies Dept — GPGC Mansehra</div>
    </div></div>
</div>
...
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">International Conference on Contemporary Islamic Thought 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Quranic Studies Workshop — Tafsir and Tajweed <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Department of Islamic Studies Launches Research Journal Al-Tafheem <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Seminar on Seerat-un-Nabi SAW in Modern Context</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Quran and Hadith Competition</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Islamic Economics and Finance</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Workshop on Comparative Religion and Interfaith Harmony</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">International Conference on Contemporary Islamic Thought 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Quranic Studies Workshop — Tafsir and Tajweed <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Department of Islamic Studies Launches Research Journal Al-Tafheem <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Islamic Studies</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Tafsir Competition Registration Open <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Islamic Studies Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Arabic Language Course Starting Soon <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Research Proposals Invited for Islamic Journal</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship for Islamic Studies Students</a><span class="n-date">10 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> islamiat@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Islamic Studies Block, GPGCM Mansehra</li>
