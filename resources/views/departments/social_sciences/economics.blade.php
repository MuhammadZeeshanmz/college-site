...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Economics</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Economics</div>
<div class="dept-grid">
...
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/economics-dept.jpg') }}" alt="Economics"> --}}
            <div class="intro-photo-ph">📈</div>
            <div class="intro-txt"><p>Welcome to the Department of Economics at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Economics.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/economics-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">📈</div>
        <div class="gallery-caption">Economics Dept — GPGC Mansehra</div>
    </div></div>
</div>
...
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">National Conference on Economic Development and Policy 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Econometrics Using STATA and EViews <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Economics Department Launches Research Cell for Policy Analysis <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Guest Lecture on Pakistan's Economic Challenges and Opportunities</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Economics Quiz Competition 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Seminar on Role of State Bank in Economic Stability</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">MoU Signed with State Bank of Pakistan for Research Collaboration</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">National Conference on Economic Development and Policy 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Econometrics Using STATA and EViews <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Economics Department Launches Research Cell for Policy Analysis <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
            <ul>
                ...
                <li><a href="#">Econometrics Lab</a></li>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Economics</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            ...
            <li><a href="#">BS Economics Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Econometrics Workshop Registration Open <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Research Grant Applications for Economics Students</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship for Economics Students Announced</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Summer Internship at State Bank of Pakistan</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> economics@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Economics Block, GPGCM Mansehra</li>
