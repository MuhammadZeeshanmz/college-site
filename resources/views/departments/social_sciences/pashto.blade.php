@extends('layouts.app')
@section('title', 'Department of Pashto — Government Postgraduate College Mansehra')
@section('content')
<style>
...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Pashto</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Pashto</div>
<div class="dept-grid">
...
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/pashto-dept.jpg') }}" alt="Pashto"> --}}
            <div class="intro-photo-ph">📜</div>
            <div class="intro-txt"><p>Welcome to the Department of Pashto at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Pashto.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/pashto-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">📜</div>
        <div class="gallery-caption">Pashto Literary Conference — GPGC Mansehra</div>
    </div></div>
</div>
...
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">International Pashto Conference 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Pashto Mushaira — Renowned Poets to Participate <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Department of Pashto Launches Research Journal Pukhto <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Workshop on Pashto Creative Writing and Journalism</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">All Pakistan Inter-Collegiate Pashto Debate Competition</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Seminar on Pashto Language and Modern Challenges</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Guest Lecture by Famous Pashto Novelist</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">International Pashto Conference 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Pashto Mushaira — Renowned Poets to Participate <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Department of Pashto Launches Research Journal Pukhto <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
            <ul>
                ...
                <li><a href="#">Pashto Adabi Jirga</a></li>
            ...
            <ul>
                ...
                <li><a href="#">Literary Society</a></li>
            </ul>
        </div>
    </div></div>
</div>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Pashto</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Pashto Mushaira Registration Open for Students <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Pashto Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Research Journal Pukhto Call for Papers <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Pashto Language Course for Beginners</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship for Pashto Students Announced</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Mid-Term Exam Schedule Spring 2025 Released</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> pashto@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Pashto Block, GPGCM Mansehra</li>
