...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Physics</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Physics</div>
<div class="dept-grid">
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/physics-dept.jpg') }}" alt="Physics"> --}}
            <div class="intro-photo-ph">⚛️</div>
            <div class="intro-txt"><p>Welcome to the Department of Physics at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Physics.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/physics-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">⚛️</div>
        <div class="gallery-caption">Physics Lab — GPGC Mansehra</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">National Physics Symposium 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Quantum Computing Fundamentals <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Physics Department Receives Research Equipment Grant from HEC <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">International Astronomy Observation Night</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Physics Olympiad 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Semiconductor Physics and Applications</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Physics Department Industrial Visit to Hydropower Project</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">National Physics Symposium 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Quantum Computing Fundamentals <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Physics Department Receives Research Equipment Grant from HEC <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
                                <ul>
                                    <li><a href="{{ route('department.hod', 'physics') }}">HOD's Message</a></li>
                                    <li><a href="{{ route('department.show', 'physics') }}">BS Computer Science</a></li>
                                    <li><a href="{{ route('department.goals', 'physics') }}">Program Goals</a></li>
                                    <li><a href="{{ route('department.course', 'physics') }}">Course Outline</a></li>
                                    <li><a href="{{ route('department.labs', 'physics') }}">Labs</a></li>
                                    <li><a href="{{ route('department.faculty', 'physics') }}">Faculty Members</a></li>
                                </ul>
                                <ul>
                                    <li><a href="{{ route('department.semester', 'physics') }}">Semester Rules</a></li>
                                    <li><a href="{{ route('department.fee', 'physics') }}">Fee Structure</a></li>
                                    <li><a href="{{ route('department.admissions', 'physics') }}">Admissions</a></li>
                                    <li><a href="{{ route('department.datesheets', 'physics') }}">Date Sheets</a></li>
                                    <li><a href="{{ route('department.results', 'physics') }}">Results</a></li>
                                    <li><a href="{{ route('department.downloads', 'physics') }}">Downloads</a></li>
                                </ul>
                            </div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Physics</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Physics Lab Practical Exams Schedule Spring 2025 <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Physics Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Research Proposal Submission Deadline Extended <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Summer Internship Program at PAEC</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship for Physics Students Announced</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Astronomy Club Meeting — All Students Welcome</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> physics@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Physics Block, GPGCM Mansehra</li>
