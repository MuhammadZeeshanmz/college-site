...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Zoology</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Zoology</div>
<div class="dept-grid">
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/zoology-dept.jpg') }}" alt="Zoology"> --}}
            <div class="intro-photo-ph">🦋</div>
            <div class="intro-txt"><p>Welcome to the Department of Zoology at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Zoology.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/zoology-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">🦋</div>
        <div class="gallery-caption">Zoology Museum and Lab — GPGC Mansehra</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">National Wildlife Conservation Symposium 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Field Trip to Ayubia National Park for Biodiversity Study <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Zoology Department Launches Marine Biology Research Program <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Workshop on Molecular Biology Techniques PCR and Gel Electrophoresis</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Zoology Olympiad 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Endangered Species of Pakistan</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Research Collaboration with WWF Pakistan</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">National Wildlife Conservation Symposium 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Field Trip to Ayubia National Park for Biodiversity Study <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Zoology Department Launches Marine Biology Research Program <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
            <ul><li><a href="#">HOD's Message</a></li><li><a href="#">BS Zoology</a></li><li><a href="#">Program Goals</a></li><li><a href="#">Course Outline</a></li><li><a href="#">Laboratories</a></li><li><a href="#">Faculty Members</a></li></ul>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Zoology</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Zoology Museum Open House for Students <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Zoology Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Summer Research Internship at Wildlife Department <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Scholarship for Fisheries and Aquaculture Students</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Wildlife Photography Competition</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Field Study Trip to Himalayan Region</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> zoology@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Zoology Block, GPGCM Mansehra</li>
