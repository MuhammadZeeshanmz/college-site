...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Information Technology</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Information Technology</div>
<div class="dept-grid">
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/it-dept.jpg') }}" alt="Information Technology"> --}}
            <div class="intro-photo-ph">🖧</div>
            <div class="intro-txt"><p>Welcome to the Department of Information Technology at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Information Technology.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/it-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">🖧</div>
        <div class="gallery-caption">IT Labs — GPGC Mansehra</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">International Conference on Emerging IT Trends 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">CCNA Training Program Launched for BS IT Students <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">IT Department Launches Cybersecurity Research Center <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Hackathon 2025 — 24-Hour Coding Competition</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Workshop on Cloud Computing (AWS and Azure)</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Artificial Intelligence and Machine Learning</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">MoU Signed with Software House for BS IT Internships</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">International Conference on Emerging IT Trends 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">CCNA Training Program Launched for BS IT Students <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">IT Department Launches Cybersecurity Research Center <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
    <ul>
        <li><a href="{{ route('department.hod', 'it') }}">HOD's Message</a></li>
        <li><a href="{{ route('department.show', 'it') }}">BS Information Technology</a></li>
        <li><a href="{{ route('department.goals', 'it') }}">Program Goals</a></li>
        <li><a href="{{ route('department.course', 'it') }}">Course Outline</a></li>
        <li><a href="{{ route('department.labs', 'it') }}">Labs</a></li>
        <li><a href="{{ route('department.faculty', 'it') }}">Faculty Members</a></li>
    </ul>
    <ul>
        <li><a href="{{ route('department.semester', 'it') }}">Semester Rules</a></li>
        <li><a href="{{ route('department.fee', 'it') }}">Fee Structure</a></li>
        <li><a href="{{ route('department.admissions', 'it') }}">Admissions</a></li>
        <li><a href="{{ route('department.datesheets', 'it') }}">Date Sheets</a></li>
        <li><a href="{{ route('department.results', 'it') }}">Results</a></li>
        <li><a href="{{ route('department.downloads', 'it') }}">Downloads</a></li>
    </ul>
</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Information Technology</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Mid-Term Exam Schedule Spring 2025 Released <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS IT Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Fee Submission Deadline Spring 2025 <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">IT Lab Schedule Spring 2025 Available</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship Applications Open for IT Students</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Internship Opportunities at Software Companies</a><span class="n-date">01 Mar 2025</span></li>
            <li><a href="#">Class Timetable Spring 2025 on Notice Board</a><span class="n-date">15 Feb 2025</span></li>
            {{-- Duplicate --}}
            <li><a href="#">Mid-Term Exam Schedule Spring 2025 Released <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS IT Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Fee Submission Deadline Spring 2025 <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> it@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Information Technology Block, GPGCM Mansehra</li>
