...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Mathematics</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Mathematics</div>
<div class="dept-grid">
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/mathematics-dept.jpg') }}" alt="Mathematics"> --}}
            <div class="intro-photo-ph">📐</div>
            <div class="intro-txt"><p>Welcome to the Department of Mathematics at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Mathematics.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/mathematics-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">📐</div>
        <div class="gallery-caption">Mathematics Dept — GPGC Mansehra</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">International Mathematics Olympiad Training Camp 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">National Mathematics Conference 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Workshop on Mathematical Modeling Using MATLAB <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Mathematics Department Secures HEC Research Grant</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Mathematics Quiz Competition 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Applications of Calculus in Engineering</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Mathematics Society Annual Event 2024</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">International Mathematics Olympiad Training Camp 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">National Mathematics Conference 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Workshop on Mathematical Modeling Using MATLAB <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
            <ul><li><a href="#">HOD's Message</a></li><li><a href="#">BS Mathematics</a></li><li><a href="#">Program Goals</a></li><li><a href="#">Course Outline</a></li><li><a href="#">Laboratories</a></li><li><a href="#">Faculty Members</a></li></ul>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Mathematics</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            ...
            <li><a href="#">BS Mathematics Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Mathematics Olympiad Registration Open <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Scholarship for Meritorious Math Students</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Research Symposium on Pure and Applied Mathematics</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">MATLAB Training Workshop for BS Students</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> math@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Mathematics Block, GPGCM Mansehra</li>
