...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Botany</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Botany</div>
<div class="dept-grid">
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/botany-dept.jpg') }}" alt="Botany"> --}}
            <div class="intro-photo-ph">🌿</div>
            <div class="intro-txt"><p>Welcome to the Department of Botany at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Botany.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/botany-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">🌿</div>
        <div class="gallery-caption">Botany Lab — GPGC Mansehra</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">National Conference on Plant Biodiversity and Conservation 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Botanical Expedition to Himalayan Forests <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Department of Botany Launches Medicinal Plants Research Center <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Workshop on Plant Tissue Culture Techniques</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Botany Olympiad 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Ethnobotany of Northern Pakistan</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Collaboration with Pakistan Forest Institute</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">National Conference on Plant Biodiversity and Conservation 2025 <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Botanical Expedition to Himalayan Forests <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Department of Botany Launches Medicinal Plants Research Center <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
            <ul><li><a href="#">HOD's Message</a></li><li><a href="#">BS Botany</a></li><li><a href="#">Program Goals</a></li><li><a href="#">Course Outline</a></li><li><a href="#">Laboratories</a></li><li><a href="#">Faculty Members</a></li></ul>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Botany</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Mid-Term Practical Exams Schedule Spring 2025 <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Botany Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Herbarium Open for Student Research <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Summer Internship at National Herbarium</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship for Plant Sciences Students</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Medicinal Plants Awareness Workshop</a><span class="n-date">01 Mar 2025</span></li>
            <li><a href="#">Botanical Garden Planting Event</a><span class="n-date">15 Feb 2025</span></li>
            {{-- Duplicate --}}
            <li><a href="#">Mid-Term Practical Exams Schedule Spring 2025 <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Botany Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Herbarium Open for Student Research <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> botany@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Botany Block, GPGCM Mansehra</li>
