...
<div class="dept-breadcrumb"><div class="wrap"><a href="{{ url('/') }}">Home</a><span class="sep">›</span><a href="#">Departments</a><span class="sep">›</span><span style="color:#fff;">Department of Chemistry</span></div></div>
<div class="dept-page"><div class="dept-wrap">
<div class="dept-page-title">Department of Chemistry</div>
<div class="dept-grid">
<div>
    <div class="dc"><div class="dc-hdr">Introduction</div><div class="dc-body">
        <div class="intro-row">
            {{-- Real image: <img class="intro-photo" src="{{ asset('images/chemistry-dept.jpg') }}" alt="Chemistry"> --}}
            <div class="intro-photo-ph">🧪</div>
            <div class="intro-txt"><p>Welcome to the Department of Chemistry at Government Postgraduate College Mansehra!</p><p>Our department takes great pride in offering undergraduate degree programs in the field of Chemistry.</p></div>
        </div>
        <div class="intro-more"><p>Our .....</p></div>
        <a href="#" class="btn-read-more">READ MORE</a>
    </div></div>
    <div class="dc"><div class="dc-hdr">Department Gallery</div><div style="padding:8px;">
        {{-- Real image: <img style="width:100%;height:210px;object-fit:cover;" src="{{ asset('images/chemistry-gallery.jpg') }}" alt="Gallery"> --}}
        <div class="gallery-ph">🧪</div>
        <div class="gallery-caption">Chemistry Lab — GPGC Mansehra</div>
    </div></div>
</div>
<div>
    <div class="dc"><div class="dc-hdr">News &amp; Events</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">National Chemistry Conference 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Advanced Analytical Techniques HPLC GC-MS <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Chemistry Department Receives Research Grant for Green Chemistry <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
            <li><a href="#">Industrial Visit to Pharmaceutical Manufacturing Unit</a><span class="n-date">10 Jan 2025</span></li>
            <li><a href="#">Inter-Collegiate Chemistry Olympiad 2025</a><span class="n-date">05 Dec 2024</span></li>
            <li><a href="#">Guest Lecture on Polymer Chemistry and Applications</a><span class="n-date">20 Nov 2024</span></li>
            <li><a href="#">Environmental Chemistry Awareness Campaign</a><span class="n-date">15 Oct 2024</span></li>
            {{-- Duplicate --}}
            <li><a href="#">National Chemistry Conference 2025 at GPGCM <span class="ntag">New</span></a><span class="n-date">16 Apr 2025</span></li>
            <li><a href="#">Workshop on Advanced Analytical Techniques HPLC GC-MS <span class="ntag">New</span></a><span class="n-date">03 Mar 2025</span></li>
            <li><a href="#">Chemistry Department Receives Research Grant for Green Chemistry <span class="ntag">New</span></a><span class="n-date">15 Feb 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">Important Links</div><div class="dc-body">
        <div class="imp-wrap">
            <ul><li><a href="#">HOD's Message</a></li><li><a href="#">BS Chemistry</a></li><li><a href="#">Program Goals</a></li><li><a href="#">Course Outline</a></li><li><a href="#">Laboratories</a></li><li><a href="#">Faculty Members</a></li></ul>
...
<div>
    <div class="dc"><div class="dc-hdr">Programs Offered</div><div class="dc-body" style="padding:10px 14px;">
        ...
        <tbody><tr><td>1</td><td><a href="#">BS Chemistry</a></td><td><span class="pb bs">BS</span></td><td>4 Years</td></tr></tbody></table>
    ...
    <div class="dc"><div class="dc-hdr">Announcements</div><div class="dc-body" style="padding:10px 14px;">
        <div class="scroll-wrap"><div class="scroll-inner"><ul class="nl">
            <li><a href="#">Chemistry Practical Exams Schedule Spring 2025 <span class="ntag">New</span></a><span class="n-date">10 Apr 2025</span></li>
            <li><a href="#">BS Chemistry Admissions Open for Fall 2025 <span class="ntag">New</span></a><span class="n-date">05 Apr 2025</span></li>
            <li><a href="#">Research Proposal Submission for Summer Research Program <span class="ntag">New</span></a><span class="n-date">01 Apr 2025</span></li>
            <li><a href="#">Summer Internship Program at NUST Chemistry Dept</a><span class="n-date">20 Mar 2025</span></li>
            <li><a href="#">Scholarship Announcement for Chemistry Students</a><span class="n-date">10 Mar 2025</span></li>
            <li><a href="#">Safety Training Workshop for Lab Assistants</a><span class="n-date">01 Mar 2025</span></li>
    ...
    <div class="dc"><div class="dc-hdr">📞 Contact Department</div><div class="contact-body"><ul>
        ...
        <li><strong>Email:</strong> chemistry@gpgcm.edu.pk</li>
        <li><strong>Block:</strong> Chemistry Block, GPGCM Mansehra</li>
