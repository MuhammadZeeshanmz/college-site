...
@section('title', "Registrar Office — Government Postgraduate College Mansehra")
...
<div class="breadcrumb-bar">
    <div class="inner">
        ...
        <span class="sep">›</span>
        <span class="current">Registrar Office</span>
    </div>
</div>
    ...
    <div class="admin-container">
        ...
        <div class="admin-main">
            ...
            <div class="staff-row">
                ...
                <div class="staff-photo">
                    {{-- <img src="{{ asset('images/staff/registrar.jpg') }}" alt="Registrar"> --}}
                    <div class="no-photo">
            ...
            <div class="staff-row">
                <div class="staff-info">
                    <div class="name">Mr. [Deputy Registrar Name]</div>
                    <div class="designation">Deputy Registrar</div>
                    <div class="contact-line">
                        <i class="fas fa-envelope"></i>
                        Email: <a href="mailto:deputy.registrar@gpgcmansehra.edu.pk">deputy.registrar@gpgcmansehra.edu.pk</a>
                    </div>
                    <div class="contact-line">
                        <i class="fas fa-phone"></i>
                        Phone No: +92-997-000003
                    </div>
                </div>
                <div class="staff-photo">
                    {{-- <img src="{{ asset('images/staff/deputy-registrar.jpg') }}" alt="Deputy Registrar"> --}}
                    <div class="no-photo">
                        <svg viewBox="0 0 100 120" fill="#90a4b7" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="50" cy="32" r="22"/>
                            <path d="M10 110 Q10 72 50 72 Q90 72 90 110Z"/>
            ...
            <div class="staff-row">
                <div class="staff-info">
                    <div class="name">Ms. [Assistant Registrar Name]</div>
                    <div class="designation">Assistant Registrar</div>
                    <div class="contact-line">
                        <i class="fas fa-envelope"></i>
                        Email: <a href="mailto:ar@gpgcmansehra.edu.pk">ar@gpgcmansehra.edu.pk</a>
                    </div>
                    <div class="contact-line">
                        <i class="fas fa-phone"></i>
                        Phone No: +92-997-000004
                    </div>
                </div>
                <div class="staff-photo">
                    {{-- <img src="{{ asset('images/staff/ar.jpg') }}" alt="Assistant Registrar"> --}}
                    <div class="no-photo">
                        <!-- Female silhouette -->
                        <svg viewBox="0 0 100 120" fill="#90a4b7" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="staff-row">
                <div class="staff-info">
                    <div class="name">Mr. [Section Officer Name]</div>
                    <div class="designation">Section Officer</div>
                    <div class="contact-line">
                        <i class="fas fa-envelope"></i>
                        Email: <a href="mailto:registrar@gpgcmansehra.edu.pk">registrar@gpgcmansehra.edu.pk</a>
                    </div>
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="#" class="active">Registrar Office</a>
